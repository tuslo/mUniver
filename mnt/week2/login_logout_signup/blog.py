...
bottle.TEMPLATE_PATH.insert(0 , '/var/data/shared/week2/login_logout_signup/views')
...
bottle.debug(True)
bottle.run(host='0.0.0.0', port=80)         # Start the webserver running and wait for requests
